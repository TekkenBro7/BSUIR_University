...
int main() {
    ...
    file1.open("output/no_smt/no_smt.txt", std::ios::out);
    file2.open("output/no_smt/no_smt_iter1.txt", std::ios::out);
    file3.open("output/no_smt/no_smt_iter2.txt", std::ios::out);
    file4.open("output/no_smt/no_smt_iter3.txt", std::ios::out);
    file5.open("output/no_smt/no_smt_iter4.txt", std::ios::out);
    file6.open("output/no_smt/no_smt_iter5.txt", std::ios::out);
    file7.open("output/no_smt/no_smt_iter6.txt", std::ios::out);
    file8.open("output/no_smt/no_smt_iter7.txt", std::ios::out);
    file9.open("output/no_smt/no_smt_iter8.txt", std::ios::out);
    file10.open("output/no_smt/no_smt_iter9.txt", std::ios::out);
    file11.open("output/no_smt/no_smt_iter10.txt", std::ios::out);
    file12.open("output/no_smt/no_smt_iter11.txt", std::ios::out);
    file13.open("output/no_smt/no_smt_iter12.txt", std::ios::out);
