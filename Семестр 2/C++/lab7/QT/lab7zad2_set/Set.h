...
private:
    ...
    int tabs = 0;
    void print_flowchart(Node<T>* node, QString& s)
    {
        if (node == nullptr)
        {
            return;
...
public:
    ...
    void prefix(Node<T>* node, QString& s)
    {
        if (node == NULL)
        {
            return;
    ...
    void postfix(Node<T>* node, QString& s)
    {
        if (node == NULL)
        {
            return;
    ...
    void infix(Node<T>* node, QString& s)
    {
        if (node == NULL)
        {
            return;
